...
class Node(PropertiesGrouping, Visitable):
...
class Link(Node):
    ...
    alternate = ArrayProperty(
        "alternate", required=False, item_parser=TypeParser("Link")
    )
    children = ArrayProperty("children", required=False, item_parser=TypeParser("Link"))
